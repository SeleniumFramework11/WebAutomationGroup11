...
public class TestSelectGenre extends SelectGenre {
    ...
    public void initElements() {
        ...
        MainPage.clickMoviesLink();
    }
    @Test
    public void testGenreDropDown() throws InterruptedException {
        Thread.sleep(3000);
        selectGenreDropDown();
    }
}
